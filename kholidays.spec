...
Version  : 5.68.0
Release  : 28
URL      : https://download.kde.org/stable/frameworks/5.68/kholidays-5.68.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.68/kholidays-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/kholidays-5.68.0.tar.xz.sig
...
%prep
%setup -q -n kholidays-5.68.0
cd %{_builddir}/kholidays-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584298641
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kholidays-5.68.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kholidays/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Holidays.so.5.68.0
