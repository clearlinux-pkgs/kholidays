...
Version  : 5.60.0
Release  : 20
URL      : https://download.kde.org/stable/frameworks/5.60/kholidays-5.60.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.60/kholidays-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/kholidays-5.60.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563039263
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Holidays.so.5.60.0
