...
Source0  : https://download.kde.org/stable/frameworks/5.113/kholidays-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/kholidays-5.113.0.tar.xz.sig
...
%prep
%setup -q -n kholidays-5.113.0
cd %{_builddir}/kholidays-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702991748
mkdir -p clr-build
pushd clr-build
