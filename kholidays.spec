...
Version  : 5.105.0
Release  : 64
URL      : https://download.kde.org/stable/frameworks/5.105/kholidays-5.105.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.105/kholidays-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/kholidays-5.105.0.tar.xz.sig
...
%prep
%setup -q -n kholidays-5.105.0
cd %{_builddir}/kholidays-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681144818
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Holidays.so.5.105.0
