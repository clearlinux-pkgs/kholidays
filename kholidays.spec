...
Version  : 5.101.0
Release  : 59
URL      : https://download.kde.org/stable/frameworks/5.101/kholidays-5.101.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.101/kholidays-5.101.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.101/kholidays-5.101.0.tar.xz.sig
...
%prep
%setup -q -n kholidays-5.101.0
cd %{_builddir}/kholidays-5.101.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671050734
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Holidays.so.5.101.0
